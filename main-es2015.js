...
const pickFile = (file) => Object(lodash__WEBPACK_IMPORTED_MODULE_2__["pick"])(file, [
    'name',
    'lastModified',
    'lastModifiedDate',
    'webkitRelativePath',
...
let InputFileReaderComponent = class InputFileReaderComponent {
    constructor() {
    ...
    fileChange({ target }) {
        ...
        this.reader.onload = () => {
            ...
            this.readedFile.emit(Object.assign({}, pickFile(file), { result }));
            target.value = '';
        };
    }
};
...
const components = [_common_components__WEBPACK_IMPORTED_MODULE_2__["InputFileReaderComponent"]];
...
let IncludesPipe = class IncludesPipe {
    transform(collection, target, fromIndex = 0) {
...
let ToolbarIconComponent = class ToolbarIconComponent {
    constructor() {
        this.isVisible = true;
        this.isActive = false;
    }
...
let ToolbarService = class ToolbarService {
    ...
    getActiveObs() { return this.activeObs.asObservable(); }
    setActive(active) { this.activeObs.next(active); }
};
